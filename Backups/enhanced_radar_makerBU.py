...
def generate_enhanced_radar(radar_data: Dict) -> plt.Figure:
    ...
    try:
        ...
        try:
            # Fallback to online Roboto fonts
            font_bold = FontManager('https://github.com/google/fonts/raw/main/apache/roboto/Roboto-Bold.ttf')
            font_regular = FontManager('https://github.com/google/fonts/raw/main/apache/roboto/Roboto-Regular.ttf')
        except:
